...
class Logger {
    ...
    private val errStream = DelegatePrintStream { outputError(LogMessage(LogLevel.ERROR, it.trim())) }
    val outStream = DelegatePrintStream { output(LogMessage(LogLevel.INFO, it.trim())) }
